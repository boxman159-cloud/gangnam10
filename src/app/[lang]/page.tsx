...
const homeFaqs: Record<Lang, { question: string; answer: string }[]> = {
  ko: [
    { question: '하이퍼블릭이 무엇인가요?', answer: '하이퍼블릭(High Public)은 퍼블릭에서 발전한 상위 형태의 엔터테인먼트입니다. 독립 공간 기반의 즉석 선택과 프라이빗한 분위기, 퍼블릭의 빠른 진행이 결합된 구조입니다.' },
  ...
  en: [
    { question: "What's high public?", answer: 'High Public is an evolved, upscale form of entertainment built on instant selection in independent, private rooms with the fast pace of a public venue.' },
  ...
  cn: [
    { question: 'High Public是什么？', answer: 'High Public是从公共场所发展而来的高级娱乐形式，采用独立空间即时挑选的结构，兼具私密氛围与公共场所的快节奏。' },
  ...
  jp: [
    { question: 'ハイパブリックとは何ですか？', answer: 'ハイパブリック(High Public)は퍼블릭から発展した上位の形態のエンターテインメントです。独立した空間での即時選択とプライベートな雰囲気、퍼블릭のスピーディーな進行が組み合わさっています。' },
