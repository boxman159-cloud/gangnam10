...
const content = {
  ko: {
    ...
    guides: [
      ...
      { icon: '🎉', situation: 'Grand Party', title: '화려하고 큰 자리를 원한다면', venues: ['퍼펙트'], desc: '강남 하이퍼블릭 중 최대 규모를 자랑하는 퍼펙트입니다. VVIP 대형룸, 화려한 공연까지 갖춰 화려한 파티 자리로는 압도적입니다.' },
  ...
  en: {
    ...
    guides: [
      ...
      { icon: '🎉', situation: 'Grand Party', title: 'For a Lavish, Grand Night Out', venues: ['Perfect'], desc: "Perfect boasts the largest scale among Gangnam high public venues. With VVIP grand rooms and vibrant performances, it's unrivaled for lavish parties." },
  ...
  cn: {
    ...
    guides: [
      ...
      { icon: '🎉', situation: '豪华派对', title: '想要华丽盛大的场面', venues: ['퍼펙트'], desc: '퍼펙트是江南High Public中规模最大的场所。VVIP大型包间一应俱全，豪华派对首选无可匹敌。' },
  ...
  jp: {
    ...
    guides: [
      ...
      { icon: '🎉', situation: '豪華なパーティー', title: '華やかな大きな席なら', venues: ['퍼펙트'], desc: '퍼펙트は江南ハイパブリック最大規模を誇ります。VVIPラージルームまで揃い豪華なパーティー席として圧倒的です。' },
