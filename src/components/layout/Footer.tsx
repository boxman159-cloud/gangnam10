...
const text = {
  ko: {
    tagline: '강남 하이퍼블릭 가라오케 통합 예약 안내. 달토·퍼펙트·유앤미·도파민·엘리트·디저트 등 강남권 주요 업장을 빠르고 정확하게 연결해 드립니다.',
    serviceTitle: '서비스',
    links: [
    ...
    kakao: '💬 카카오톡: alrep0410',
    notice: '24시간 연중무휴 예약 문의',
    copyright: '© 2026 강남 하이퍼블릭. All rights reserved.',
    legal: ['이용약관', '개인정보처리방침', '사업자정보'],
  },
  en: {
    tagline: 'An integrated booking guide for Gangnam high public karaoke — connecting you quickly and accurately to Dalto, Perfect, U&ME, Dopamine, Elite, Dessert, and more.',
  ...
  ja: {
    tagline: '江南ハイパブリックカラオケ統合予約案内。달토·퍼펙트·유앤미·도파민·엘리트·디저트など江南主要店舗へ迅速かつ正確にご案内します。',
    serviceTitle: 'サービス',
    links: [
