...
export const venueTranslations: VenueTranslationMap = {
  ...
  perfect: {
    en: {
      description: "Perfect occupies the site of the legendary Octagon Club, making it Gangnam's largest high-public KTV venue. Open every day, weekday or weekend, with expansive VVIP rooms, the scale and choice are unmatched. A fixed-rate pricing system keeps costs transparent, and a high ratio of solo guests means it's just as comfortable to visit alone. Transgender performances during select time slots are a unique, popular draw. It's inside Eliana Hotel B1/B2 in Nonhyeon-dong, 7 minutes on foot from Eonju Station (Line 9).",
      features: ["Gangnam's largest scale · Wide selection daily", 'Expansive VVIP rooms · lavish facilities', 'Performances at select times', 'Solo-visitor system fully set up'],
      ...
      faqs: [
        ...
        { question: 'Is it really the biggest high-public venue in Gangnam?', answer: 'Yes. Built on the former site of Octagon Club, it has the largest room count and floor space among Gangnam high-public venues.' },
    ...
    cn: {
      description: '퍼펙트坐落在传奇옥타곤俱乐部的旧址上，是江南规模最大的高端包房KTV。无论平日还是周末，加上宽敞的VVIP大包间，规模和选择范围首屈一指。明码标价的固定价格体系让消费透明，单人客人的比例也很高，一个人前往同样自在。特定时段的变装表演是其独特的人气亮点。位于논현동엘리에나酒店B1/B2层，距地铁9号线彦州站步行7分钟。',
      features: ['江南规模最大 · 选择丰富多样', '宽敞VVIP包间 · 豪华设施', '特定时段表演', '完善的单人访问体系'],
      ...
      faqs: [
        ...
        { question: '真的是江南规模最大吗？', answer: '是的。这里由原옥타곤俱乐部旧址改建而成，房间数量与规模在江南高端包房KTV中位居第一。' },
    ...
    jp: {
      description: '퍼펙트は伝説의옥타곤クラブの跡地に位置し、江南最大規模のハイパブリックKTVです。平日・週末問わず、広々としたVVIPルームも完備しているため、規模と選択肢は他の追随を許しません。定価制で料金体系が透明なうえ、おひとり様の比率も高く、一人での訪問も快適です。特定の時間帯に行われるトランスジェンダーパフォーマンスも人気の理由の一つです。논현동엘리에나ホテルB1/B2に位置し、地下鉄9号線彦州駅から徒歩7分です。',
      features: ['江南最大規模 · 豊富な選択肢', '広々としたVVIPルーム · 豪華な施設', '特定時間帯のパフォーマンス', 'おひとり様システム完備'],
      ...
      faqs: [
        ...
        { question: '本当に江南最大規模なのですか？', answer: 'はい。旧옥타곤クラブの跡地にできた施設で、部屋数・規模ともに江南のハイパブリックの中で最大級です。' },
