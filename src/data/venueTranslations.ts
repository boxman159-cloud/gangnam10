  ...
  dalto: {
    en: {
      ...
      faqs: [
        ...
        { question: 'How do I make a reservation?', answer: "Call 010-9778-8571 or message us on KakaoTalk (alrep0410) and we'll connect you with Dalto right away." },
    ...
    zh: {
      ...
      faqs: [
        ...
        { question: '如何预约？', answer: '请拨打电话(010-9778-8571)或添加KakaoTalk(alrep0410)咨询，我们会立即为您安排달토。' },
        { question: '可以停车吗？', answer: '可以。现场有代客泊车经理常驻，通过我们预约可享受免费代客泊车服务。' },
      ],
    },
    ja: {
      description: '달토（走るうさぎ）は驛三洞にある三井ホテルの地下に位置し、約60室を誇る江南最大級のハイパブリックカラオケです。リーズナブルな料金と親しみやすい雰囲気で、初めての方に最もおすすめする施設であり、入場もスピーディーです。入口のうさぎのぬいぐるみがトレードマークで、ホテル地下という構造のため外部への露出がほとんどなく、ビジネスの集まりにも最適です。地下鉄9号線彦州駅から徒歩約5分です。',
      ...
      faqs: [
        ...
        { question: '予約方法は？', answer: 'お電話(010-9778-8571)またはKakaoTalk(alrep0410)でお問い合わせいただければ、すぐに달토へご案内いたします。' },
  ...
  perfect: {
    en: {
      ...
      faqs: [
        ...
        { question: 'How do I make a reservation?', answer: 'Call 010-9778-8571 or message KakaoTalk (alrep0410) and we will guide you right away.' },
        { question: 'Is parking available?', answer: 'Yes. A valet is on site, and parking is complimentary when you book through us.' },
      ],
    },
    zh: {
      ...
      faqs: [
        ...
        { question: '如何预约？', answer: '请拨打电话(010-9778-8571)或添加KakaoTalk(alrep0410)咨询，我们会立即为您安排。' },
        { question: '可以停车吗？', answer: '可以。现场有代客泊车经理常驻，通过我们预约可享受免费代客泊车服务。' },
      ],
    },
    ja: {
      description: '퍼펙트は伝説의옥타곤クラブの跡地に位置し、江南最大規模のハイパブリックカラオケです。平日・週末問わず毎日100~150名以上のスタッフが出勤し、広々としたVVIPルームも完備しているため、規模と選択肢は他の追随を許しません。定価制で料金体系が透明なうえ、おひとり様の比率も高く、一人での訪問も快適です。特定の時間帯に行われるトランスジェンダーパフォーマンスも人気の理由の一つです。논현동엘리에나ホテルB1/B2に位置し、地下鉄9号線彦州駅から徒歩7分です。',
      ...
      faqs: [
        ...
        { question: '予約方法は？', answer: 'お電話(010-9778-8571)またはKakaoTalk(alrep0410)でお問い合わせいただければ、すぐにご案内いたします。' },
        { question: '駐車は可能ですか？', answer: 'はい、可能です。バレーパーキング担当者が常駐しており、当店経由でご予約いただくと無料でご利用いただけます。' },
      ],
    },
  },
  uanme: {
    en: {
      ...
      faqs: [
        ...
        { question: 'How do I book U&ME?', answer: 'Call 010-9778-8571 or message KakaoTalk (alrep0410) and we will guide you right away.' },
    ...
    zh: {
      ...
      faqs: [
        ...
        { question: '如何预约유앤미？', answer: '请拨打电话(010-9778-8571)或添加KakaoTalk(alrep0410)咨询，我们会立即为您安排。' },
